...
![Erlang VM observer](/images/erlang_vm_observer.png)
...
![Erlang VM observer](/images/erlang_vm_observer_memory_usage.png)


You can also check in *processes* tab how our ping process is doing.
![Erlang VM observer](/images/erlang_vm_observer_ping_process.png)
...
![self() queue process](/images/erlang_vm_observer_self_queue.png)
...
![queue msgs list](/images/erlang_vm_observer_process_queue_peek.png)
